	...
	<div class="u_sign">
		<div class="bl_c">
			<div class="usign_c">
				...
				<div class="usign_head"><h3 class="usign_h">Тарқату</h3></div>
				<div class="usign_cn">
					...
					<div class="form_im">
						<button class="btn btn_sign"><span>Кіру</span><i class="far fa-long-arrow-right"></i></button>
					</div>
					<div class="form_im si_blc_bn">
						<a class="btn btn_back3 txt_c" href="https://wa.me/77774321199">Пароль ұмыттым?</a>
					</div>
				</div>
